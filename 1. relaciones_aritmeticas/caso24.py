...
def caso_24_expresion_modular_vs_directa():
    """
    MR: Reemplazar potencias por sus valores numéricos dentro de una expresión
    no altera el resultado final tras aplicar valor absoluto.
    |3^2 − 4^2|  →  |9 − 16|.
    ...
    imprimir_resultados(
        modelo=MODEL,
        tipo=TIPO,
        caso="Caso 24: Expresión con valor absoluto y potencias (|3^2 - 4^2| vs |9-16|)",
...
if __name__ == "__main__":
    preload_model(MODEL)
    caso_24_expresion_modular_vs_directa()
