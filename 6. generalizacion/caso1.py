...
def caso_1_suma_n(n: int):

    # Caso base:
    terminos = [i for i in range(1, n + 1)]
    ...
    # Caso transformado:
    prompt_transformado = (
        f"Usa la fórmula de la suma de los primeros n números naturales S(n) = n * (n + 1) / 2, con n={n}. "
        "Responde SOLO con un número entero, sin texto adicional."
    )
    ...
    imprimir_resultados(
        modelo=MODEL,
        tipo="Generalización",
        caso=f"Suma de los primeros {n} números naturales",
