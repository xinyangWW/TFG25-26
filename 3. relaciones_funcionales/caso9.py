...
def caso_9_linealidad_escalado():
    """
    MR: Para una función lineal f(x) = 5x, se cumple f(k·x) = k·f(x).
    Evaluamos f(3·2) directamente, y también 3·f(2).
