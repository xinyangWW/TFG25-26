...
def caso_22_distribucion_binomial_acumulada():

    # Caso base:
    problema = "Sea X ~ Binomial(n=5, p=0.3). Calcula P(X ≤ 2)."
    contexto = "Ten en cuenta que P(X ≤ k) = sum_{i=0}^k C(n,i) p^i (1-p)^(n-i)"
    prompt_base = (
        f"{problema}"
...
if __name__ == "__main__":
    ...
    caso_22_distribucion_binomial_acumulada()