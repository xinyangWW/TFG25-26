...
def caso_8_ecuacion_exponencial():

    # Caso base:
    ecuacion = "2 - 3^(-x) + 3^(x+1) = 0"
    contexto = "recuerda las propiedades de las potencias y resuelve mediante el cambio de variable t=3^x"
    prompt_base = (
        f"Resuelve: {ecuacion}."
