...
def caso_19_sistema_3_incognitas_fracciones():

    # Caso base:
    sistema = ["(1/2)*x + (1/3)*y + (1/4)*z = 13/12", "(1/3)*x - (1/2)*y + (1/5)*z = 1/30", "(1/4)*x + (1/4)*y - (1/3)*z = 1/6"]
...
if __name__ == "__main__":
    ...
    caso_19_sistema_3_incognitas_fracciones()