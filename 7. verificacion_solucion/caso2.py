...
from mr_utils import evaluar_cumplimiento_mr, extraer_soluciones, evaluar_solucion_general, formatear_soluciones
from print_results import imprimir_resultados

MODEL = sys.argv[1] if len(sys.argv) > 1 else "chatgpt"

def caso_2_ecuacion_raices_signo():
