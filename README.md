...
En este repositorio se encuentra todo lo relacionado con el código desarrollado para nuestro Trabajo de Fin de Grado "Poniendo a prueba a la IA con Matemáticas". La idea general del TFG es evaluar la consistencia y robustez de tres modelos de IA mediante Pruebas Metamórficas. El código está escrito el Pyhton debido a su cercanía con la IA y la disponibilidad de bibliotecas y herramientas que facilitan la interacción con los modelos. El trabajo esta dividido en carpetas, en cada cual se encuentran las diferentes pruebas diseñadas por los miembros del equipo para cada tipo de relación metamórfica. El resto de archivos Python son scripts empleados para la agregación de resultados, automatización de las pruebas, la normalización y evaluación de resultados, y la visualización de los resultados. También se encuentran en el repositorio los resultados y gráficas generados tras los experimentos, así como una última carpeta con algunos experimentos descartados.
